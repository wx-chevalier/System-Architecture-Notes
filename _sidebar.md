  ...
  - [2 风格与模式](/风格与模式/README.md)
    ...
    - [2.8 领域驱动设计](/风格与模式/领域驱动设计/README.md)
      ...
      - 2.8.2 基础概念
        ...
        - [2.8.2.3 聚合与聚合根](/风格与模式/领域驱动设计/基础概念/聚合与聚合根.md)
        - [2.8.2.4 领域事件](/风格与模式/领域驱动设计/基础概念/领域事件.md)
        - [2.8.2.5 领域对象](/风格与模式/领域驱动设计/基础概念/领域对象.md)
      - [2.8.3 领域划分](/风格与模式/领域驱动设计/领域划分/README.md)
        - [2.8.3.1 事件风暴](/风格与模式/领域驱动设计/领域划分/事件风暴.md)
        - [2.8.3.2 提炼问题域](/风格与模式/领域驱动设计/领域划分/提炼问题域.md)
        - [2.8.3.3 通用语言](/风格与模式/领域驱动设计/领域划分/通用语言.md)
        - [2.8.3.4 限界上下文](/风格与模式/领域驱动设计/领域划分/限界上下文.md)
      - [2.8.4 分层架构](/风格与模式/领域驱动设计/分层架构/README.md)
        - [2.8.4.1 代码模型](/风格与模式/领域驱动设计/分层架构/代码模型.md)
        - [2.8.4.2 层的划分](/风格与模式/领域驱动设计/分层架构/层的划分.md)
        - [2.8.4.3 服务与数据协作](/风格与模式/领域驱动设计/分层架构/服务与数据协作.md)
        - [2.8.4.4 架构演化](/风格与模式/领域驱动设计/分层架构/架构演化.md)
        - [2.8.4.5 领域事件](/风格与模式/领域驱动设计/分层架构/领域事件.md)
      - 2.8.5 应用案例
        ...
        - [2.8.5.3 保险电商系统](/风格与模式/领域驱动设计/应用案例/保险电商系统/README.md)
          
        - 2.8.5.4 数字钱包系统
          - [2.8.5.4.1 代码设计](/风格与模式/领域驱动设计/应用案例/数字钱包系统/代码设计.md)
          - [2.8.5.4.2 银行转账](/风格与模式/领域驱动设计/应用案例/数字钱包系统/银行转账.md)
