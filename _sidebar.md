  ...
  - [3 模式与风格](/模式与风格/README.md)
    ...
    - [3.8 领域驱动设计](/模式与风格/领域驱动设计/README.md)
      - [3.8.1 分层架构](/模式与风格/领域驱动设计/分层架构/README.md)
        - [3.8.1.1 层的划分](/模式与风格/领域驱动设计/分层架构/层的划分.md)
        - [3.8.1.2 领域事件](/模式与风格/领域驱动设计/分层架构/领域事件.md)
      - 3.8.2 基础概念
      ...
      - 3.8.3 应用案例
        ...
        - [3.8.3.3 银行转账](/模式与风格/领域驱动设计/应用案例/银行转账.md)
      - [3.8.4 设计与建模](/模式与风格/领域驱动设计/设计与建模/README.md)
        - [3.8.4.1 用例分析与关系推导](/模式与风格/领域驱动设计/设计与建模/用例分析与关系推导.md)
        - [3.8.4.2 领域划分](/模式与风格/领域驱动设计/设计与建模/领域划分.md)
